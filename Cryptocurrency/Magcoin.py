...
def mine_block():
    ...
    # Reward for miner
    blockchain.add_transaction(sender = node_address, receiver = 'Miner', amount = 1000)
...
def add_transaction():
    ...
    if not all ( key in json for key in transaction_keys):
        return 'Some of the elements of trabsaction are missing', 400
...
def connect_node():
    ...
    response = {'message': 'All nodes are connectes. The Magcoin blockchain nowcontains the following nodes.',
